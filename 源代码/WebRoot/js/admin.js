		       ...
		       text: "创新类型管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "InnovateType/innovateType_add.jsp"
			    	   	},
			    		{
			    	   		text: "创新类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "InnovateType/innovateType_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "学生创新管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Innovate/innovate_add.jsp"
			    	   	},
			    		{
			    	   		text: "学生创新管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Innovate/innovate_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
