...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">学分认定管理</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>Student/frontlist">学生查询</a></li>
                <li><a href="<%=basePath %>ClassInfo/frontlist">班级查询</a></li>
                <li><a href="<%=basePath %>InnovateType/frontlist">创新类型</a></li>
                <li><a href="<%=basePath %>Innovate/frontlist">学生创新项目</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Innovate/innovate_frontStudentAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;学生创新学分申请</a></li>
                        <li><a href="<%=basePath %>Innovate/studentFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的学生创新</a></li>
