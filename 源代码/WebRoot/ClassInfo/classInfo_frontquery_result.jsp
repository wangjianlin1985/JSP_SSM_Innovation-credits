...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>班级编号</td><td>班级名称</td><td>所在学院</td><td>所在专业</td><td>班主任</td><td>成立日期</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=classInfo.getCollegeName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="classInfoQueryForm" id="classInfoQueryForm" action="<%=basePath %>ClassInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="collegeName">所在学院:</label>
				<input type="text" id="collegeName" name="collegeName" value="<%=collegeName %>" class="form-control" placeholder="请输入所在学院">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="classInfo_collegeName_edit" class="col-md-3 text-right">所在学院:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="classInfo_collegeName_edit" name="classInfo.collegeName" class="form-control" placeholder="请输入所在学院">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (classInfo, response, status) {
			if (classInfo) {
				...
				$("#classInfo_collegeName_edit").val(classInfo.collegeName);
